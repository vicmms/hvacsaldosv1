...
<div class="flex">
    <li class="bg-white rounded-lg shadow mb-4 flex-1 {{Auth::user()->email == 'yoliesglez@gmail.com' ? 'max-w-3xl' : ''}}">
        <article class="md:flex ">
            <figure class="self-center ml-2 w-32" style="text-align: -webkit-center">
                <img class="{{Auth::user()->email == 'yoliesglez@gmail.com' ? 'h-24' : 'h-36 w-40'}} rounded-sm  object-cover object-center"
            ...
            <div class="flex-1 py-4 px-6 flex flex-col">
                <div class="lg:flex justify-between">
                    <div class="flex-1">
                        ...
                        <p class="font-bold text-gray-700 {{Auth::user()->email == 'yoliesglez@gmail.com' ? 'hidden' : ''}}">
                ...
                <div class="mt-4 md:mt-auto mb-4 {{Auth::user()->email == 'yoliesglez@gmail.com' ? 'hidden' : ''}}">
