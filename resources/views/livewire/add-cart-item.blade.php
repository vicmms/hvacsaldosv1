<div x-data>
    ...
    <div class="flex">
        <div class="mr-4">
            <x-jet-secondary-button class="font-bold text-xl" style="padding: .2rem .7rem !important;" disabled
            ...
            <x-jet-secondary-button class="font-bold text-xl" style="padding: .2rem .65rem !important;"
