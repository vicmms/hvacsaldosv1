<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-700">
    ...
    <div class="grid grid-cols-3 gap-6 mb-4">
        ...
        <div>
            ...
            <x-jet-input wire:model="price" type="number" class="w-full" step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" />
        ...
        <div>
            ...
            <x-jet-input wire:model="commercial_price" type="number" class="w-full" step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" />
